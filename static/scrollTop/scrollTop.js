...
function initScrollTop(obj){
	...
	var addCss = function(){
		var cssText = "#scrollTop{ position: fixed; right: 0; top: 80%; width: 72px; height: 180px; background: url('http://tomieric.github.io/old-blog/static/scrollTop/rocket_up.png') no-repeat -40px 0; cursor: pointer; z-index: 8; }#scrollTop div{ display: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%; }#scrollTop .level-2{ background: url('static/scrollTop/rocket_up.png') no-repeat -189px 0; opacity: 1; filter: alpha(opacity=100); }";
